...
namespace CoffeeAdmin.Models
{
    public class DAL
    {
        // Allows for a single user to logon at one time.
        ...
        // Below line replaces original database connection string above:
        // (open and set parameters in "appsettings.json and "Startup.cs/configureservices
        ...
        {
            // 
            // Category { id = "COFF", description = "New decription" }
            //
            //
            cat.username = DAL.CurrentUser;
            DB.Update(cat);
        ...
        // Example of where we would operate on more that one table
