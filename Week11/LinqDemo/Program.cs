...
namespace LinqDemo
{
    class Program
    {
        ...
        delegate int TwoInts(int x, int y);  // Think of this as a type for a variable that can "hold a funtion"
        ...
        {
            int res = func(3);
            Console.WriteLine("Inside the ReceiveFunction function. Result is:");
        ...
        static bool CheckFirstLetter(string name)
        {
            if (name[0] == 'S')
            {
                // the expression evaluated to true. So return true (i.e. the same calue as the expression)
                return true;
            }
            else
            {
                // The expresssion evaluated to false. So return false (i.e. the same value as the expression)
                return false;
            }
        ...
        static void LinqDemo0()
        {
            ...
            // You can see why C# needed the ability topass a function as a parameter in order to make this work.
        ...
        static void Main(string[] args)
        {
            ...
            //    (x) =>
            //    {
            //        Console.WriteLine("We are inside an anonymous funtion");
            //        return x + x + x + x;
            //    }
            //    );
            ...
            // It knows the type based on how we're using the lambda funtion.
