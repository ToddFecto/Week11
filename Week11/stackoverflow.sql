...
update answer set questionId = 3 where id = 7;
alter table answer add Constraint fk_question_id foreign key fk__questionId (questionId) references question(id);